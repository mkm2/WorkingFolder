...
begin
	plot(L_min:L_max,probs1,yaxis=:log,label=L"\epsilon=0.1",xlabel="L",ylabel="Pr",ylims=[1e-10,5])
	plot!(L_min:L_max,probs2,yaxis=:log,label=L"\epsilon=0.01",xlabel="L",ylabel="Pr")
	plot!(L_min:L_max,probs3,yaxis=:log,label=L"\epsilon=0.001",xlabel="L",ylabel="Pr")
end
